...
output = []
filepath = '/Users/arnavagarwal/Desktop/Arnav/University/Year 2/Q3/Hackathon/webscrape_v2.csv'
        ...
        for row in rows:
            ...
            with open(filepath, 'a', newline='') as file:
                ...
                if isinstance(days, list):
                    for day in days:
                        writer.writerow([building, room, day, stime, etime])
                else:
                    # Write the list to the CSV file as a row
                    writer.writerow([building, room, days, stime, etime])

            #tracker
            count += 1
            classcnt -= 1
            print("Department Count:"+str(depcount)+", Class Count:"+str(count)+", Current Remaining:"+str(classcnt))
